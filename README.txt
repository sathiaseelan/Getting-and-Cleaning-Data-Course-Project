...
2) Calculated the average of each value by using summarize_each function on grouped variable and saved into a variable Average_all_mean_std
3) Loading the resulting dataset Average_all_mean_std into a txt file called tidy_dataset_subject_activity_average.txt
